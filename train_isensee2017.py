...
from unet3d.model.Unet_3D_RES import Unet_3D_RES
...
config["data_file"] = os.path.abspath("data/preprocessed_2/brats_data.h5")
...
def fetch_training_data_files(return_subject_ids=False):
    ...
    subject_ids = list()
    for subject_dir in glob.glob(os.path.join(os.path.dirname(__file__), "data", "preprocessed_1", "*", "*")):
...
def main(overwrite=False):
    ...
    if not overwrite and os.path.exists(config["model_file"]):
        ...
        model = Unet_3D_RES(config["input_shape"])
